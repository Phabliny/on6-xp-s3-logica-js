...
let parametros = parseInt(pergunta("Quantos parametros você quer passar? (entre 1 e 3) "))
let valor1 = 0
let valor2 = 0
let valor3 = 1 
if (parametros === 1){
  valor1 = parseInt(pergunta("Digite o primeiro valor: "))
} else if(parametros === 2){
  valor1 = parseInt(pergunta("Digite o primeiro valor: "))
  valor2 = parseInt(pergunta("Digite o segundo valor: "))
}else if(parametros === 3){
  valor1 = parseInt(pergunta("Digite o primeiro valor: "))
  valor2 = parseInt(pergunta("Digite o segundo valor: "))
  valor3 = parseInt(pergunta("Digite o terceiro valor: "))
}else{
  console.log("Não recebeu parâmetro!")
}

function resultados(valor_1, valor_2, valor_3){
  if (parametros === 1){
...
resultados(valor1,valor2,valor3)